...
task main()
{
	...
	while(1==1)
	{
		...
		motor[frontLeftMotor] = ((-100.0)*(joystick.joy1_y2/127.0)*(joystick.joy1_y1/127.0)*(joystick.joy1_y1/127.0));
		motor[backLeftMotor] = ((-100.0)*(joystick.joy1_y2/127.0)*(joystick.joy1_y1/127.0)*(joystick.joy1_y1/127.0));
		//right two motors controlled by the left joystick in controller one
		motor[frontRightMotor] = ((-100.0)*(joystick.joy1_y1/127.0)*(joystick.joy1_y2/127.0)*(joystick.joy1_y2/127.0));
		motor[backRightMotor] = ((-100.0)*(joystick.joy1_y1/127.0)*(joystick.joy1_y2/127.0)*(joystick.joy1_y2/127.0));
